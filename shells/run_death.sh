...
THEANO_FLAGS=device=gpu1,floatX=float32 python -u train_rnn.py settings/gcn.txt settings/catAtt_lstm.txt settings/fixLength32.txt >& log/death_catAtt_gcn.log1 &
THEANO_FLAGS=device=gpu2,floatX=float32 python -u train_rnn.py settings/gcn.txt settings/catAtt_lstm.txt settings/fixLength32.txt >& log/death_catAtt_gcn.log2 &
