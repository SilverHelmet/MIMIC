...
THEANO_FLAGS=device=gpu0,floatX=float32 python -u train_rnn.py settings/cat_lstm.txt settings/fixLength1.txt >& log/death_catAtt_fixLength1_lstm.log2 &
wait

THEANO_FLAGS=device=gpu0,floatX=float32 python -u train_rnn.py settings/fea_catAtt_lstm.txt settings/fixLength1.txt  >& log/death_fea_catAtt_fixLength1_lstm.log2
