...
THEANO_FLAGS=device=cuda2,floatX=float32 python -u train_rnn.py settings/fea_gcn.txt settings/catAtt_lstm.txt settings/fixLength16.txt @gcn_numric_feature_hidden_dim=8 >& log/death_fixLength16_fea_catAtt_gcn0.5_fea=8.log1 &
THEANO_FLAGS=device=cuda0,floatX=float32 python -u train_rnn.py settings/fea_gcn.txt settings/catAtt_lstm.txt settings/fixLength16.txt @gcn_numric_feature_hidden_dim=32 >& log/death_fixLength16_fea_catAtt_gcn0.5_fea32.log1 &
