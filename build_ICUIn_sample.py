from util import *
from scripts.sample_setting import load_ICUIn_sample_setting, PatientSample, Sample
...
if __name__ == "__main__":
    ...
    writer = file(os.path.join(ICU_exper_dir, "ICU_samples_len=%d.txt" %max_event_len), 'w')
